...
export default function CandidatoPage() {
  const candidatoServices = services.filter(s => s.category === 'candidato');
      ...
      <main className="min-h-screen pt-[64px]">
        <section className="bg-aesop-bark py-6 lg:py-8">
          <div className="max-w-[900px] mx-auto px-6 lg:px-12">
            <p className="eyebrow-mono text-gold mb-4">· Para candidatos</p>
            ...
            <p className="font-sans text-[15px] font-light mt-6" style={{ color: 'rgba(242,237,228,0.7)', lineHeight: '1.8' }}>
              Programas diseñados para profesionales y estudiantes costarricenses.
            </p>
          </div>
        </section>
