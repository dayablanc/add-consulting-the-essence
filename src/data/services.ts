...
export const services: Service[] = [
  ...
  },
  {
    ...
    includes: ['Gestión integral de RR.HH.', 'Diseño de políticas internas', 'Manejo de planillas y beneficios', 'Auditorías de cumplimiento', 'Asesoría legal laboral continua'],
    faq: [
