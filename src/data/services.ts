...
export const services: Service[] = [
  ...
  },
  {
    ...
    includes: ['Diseño y optimización de CV con estándar ATS', 'Perfil de LinkedIn desde cero', 'Guía para poder pasar la primer entrevista con éxito ', 'Orientación vocacional', 'Acceso a vacantes junior'],
    showInCards: true,
    priceCRC: 16000,
    faq: [
